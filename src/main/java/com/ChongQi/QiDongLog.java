...
public class QiDongLog {

    public static void main(String[] args) {
        QiDongLog chongQi = new QiDongLog();
        chongQi.method("E://huyl//0bat");

    }


    public void method(String directory) {
...
//                            + token.getString("token") + "  --server.port=10184 > /root/huyl/bushu/nohup.out 2>&1 &";
                        String command = " source /etc/profile; nohup /root/huyl/jdk1.8.0_181/bin/java -jar /root/huyl/bushu/JianKongLog-1.0-SNAPSHOT.jar /root/huyl/bushu --server.port=10174 > /root/huyl/bushu/nohup.out 2>&1 &";
